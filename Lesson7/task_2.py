...
def task2(n):
    ...
    result = merge_sort(orig_list)
    # print(f'Отсортированный = {result}')
    return result


# замеры на 100 повторений: 10 элементов - 0.0013 секунд,100 элементов - 0.0173 секунд, 1000 элементов - 0.23 секунд
print(
    timeit.timeit(
        "task2(user_input)",
        globals=globals(),
